...
#import data frames
dftrain=pd.read_csv('/Users/christopherhamblin/Desktop/Titanic/train.csv')
dftest=pd.read_csv('/Users/christopherhamblin/Desktop/Titanic/test.csv')
...
mode_embarked = mode(dfcombi['Embarked'])[0][0]
...
importances_table.sort(key=lambda x: x[1], reverse=True)
...
dfrfresult.to_csv('/Users/christopherhamblin/Desktop/Titanic/rf1.csv', index=False)
...
dfsvmresult.to_csv('/Users/christopherhamblin/Desktop/Titanic/svm1.csv', index=False)
